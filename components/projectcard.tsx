  ...
  return (
    ...
    >
      <div className="w-2/3">
        ...
        <p className="text-sm brightness-50 flex-wrap">
          {props.project.description}
        </p>
      </div>
      <div className="flex md:flex-col pb-2 md:pb-0 text-sm text-[#A1B6EE]  font-medium">
        <div className="border-[1.5px] flex cursor-pointer hover:bg-[#A1B6EE] hover:text-black rounded-[5px] p-1 px-2 md:mb-2 mr-2 md:mr-0">
          Know More
        </div>
        <div className="border-[1.5px] cursor-pointer hover:bg-[#A1B6EE] hover:text-black rounded-[5px] p-1 px-2 ">
          View on GitHub
        </div>
      </div>
    </div>
